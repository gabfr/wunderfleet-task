<template>
    <form id="personal-informations-form" method="POST" action="" @submit.prevent="gotoNextStep">
...
<script>
    ...
    export default {
        name: 'personal-informations-form',
        computed: {
            ...mapState(['register_form'])
        },
        methods: {
            ...mapMutations(['setRegisterFormFieldValue', 'gotoNextStep'])
        }
    }
</script>
